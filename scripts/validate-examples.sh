...
#
# Only this module's own address is rewritten. examples/complete also calls the
# published namespace module, which must keep resolving from the registry —
# rewriting every terraform-temporalcloud-modules address would point that at this
# repository instead.
#
...
# The registry short name of this module: the <name> in
# terraform-temporalcloud-modules/<name>/temporalcloud.
export MODULE_NAME="nexus-endpoint"
...
for dir in examples/*/; do
  ...
  # Guard: if the rewrite matched nothing we would validate against the published
